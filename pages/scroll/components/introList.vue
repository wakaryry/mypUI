	...
	export default {
		...
		data() {
			return {
				...
				mypExtra: 180,
				loves: [
					{img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', maskType: 'mask', title: '私人FM', icon: 'solid-calendar', tag: '', desc: '听点新鲜的', descIcon: '', bgType: '', titleType: 'inverse', descType: 'inverse', iconType: 'inverse', iconStyle: 'font-size:54rpx;'},
				...
				histories: [
					{title: '在最美的春天里遇见你', desc: '13.6W人看过', img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', icon: 'triangle-right', boxStyle: 'width: 330rpx;margin-bottom:24rpx;', titleStyle: 'line-height:38rpx;', descStyle: 'line-height:34rpx;margin-top:12rpx;'},
					{title: '在最热烈的夏天爱上你', desc: '2.7W人看过', img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', icon: 'triangle-right', boxStyle: 'width: 330rpx;margin-bottom:24rpx;', titleStyle: 'line-height:38rpx;', descStyle: 'line-height:34rpx;margin-top:12rpx;'},
					{title: '在最冷的冬天温暖你。金坷垃，呵护肥料，值得拥有', desc: '58.9W人看过', img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', icon: 'triangle-right', boxStyle: 'width: 330rpx;', titleStyle: 'line-height:38rpx;', descStyle: 'line-height:34rpx;margin-top:12rpx;'}
				],
				hots: [
					{title: '一个人一座城', desc: '13.6W人看过', img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', boxStyle: 'width: 330rpx;margin-bottom:24rpx;', titleStyle: 'line-height:38rpx;', descStyle: 'line-height:34rpx;margin-top:12rpx;'},
					{title: '是兄弟就来砍我，今晚八点，不见不散', desc: '', img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', boxStyle: 'width: 330rpx;margin-bottom:24rpx;', titleStyle: 'line-height:38rpx;', descStyle: 'line-height:34rpx;'},
					{title: '在最好的年华里闯出一片天地', desc: '58.9W人看过', img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', boxStyle: 'width: 330rpx;margin-bottom:24rpx;', titleStyle: 'line-height:38rpx;', descStyle: 'line-height:34rpx;margin-top:12rpx;'},
					{title: '一个人一座城', desc: '13.6W人看过', img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', boxStyle: 'width: 330rpx;margin-bottom:24rpx;', titleStyle: 'line-height:38rpx;', descStyle: 'line-height:34rpx;margin-top:12rpx;'},
					{title: '是兄弟就来砍我，今晚八点，不见不散', desc: '', img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', boxStyle: 'width: 330rpx;margin-bottom:24rpx;', titleStyle: 'line-height:38rpx;', descStyle: 'line-height:34rpx;'},
					{title: '在最好的年华里闯出一片天地', desc: '58.9W人看过', img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', boxStyle: 'width: 330rpx;margin-bottom:24rpx;', titleStyle: 'line-height:38rpx;', descStyle: 'line-height:34rpx;margin-top:12rpx;'},
					{title: '一个人一座城', desc: '13.6W人看过', img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', boxStyle: 'width: 330rpx;margin-bottom:24rpx;', titleStyle: 'line-height:38rpx;', descStyle: 'line-height:34rpx;margin-top:12rpx;'},
					{title: '是兄弟就来砍我，今晚八点，不见不散', desc: '', img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', boxStyle: 'width: 330rpx;margin-bottom:24rpx;', titleStyle: 'line-height:38rpx;', descStyle: 'line-height:34rpx;'},
					{title: '在最好的年华里闯出一片天地', desc: '58.9W人看过', img: 'https://cdn.img.wenhairu.com/images/2020/05/23/YOcZt.jpg', boxStyle: 'width: 330rpx;', titleStyle: 'line-height:38rpx;', descStyle: 'line-height:34rpx;margin-top:12rpx;'}
				]
			}
		}
	}
