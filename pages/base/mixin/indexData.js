	...
	data() {
		return {
			items: [{
				...
				name: '图标',
				avatar: '/static/imgs/a1.jpg',
				desc: '126.6万粉丝',
				content: '支持图片/字体，并且提供Python脚本工具，快速从css中提取出icons',
				cover: '/static/imgs/c3.jpg',
				badge: 6,
				identity: '画家',
				page: 'base_icon'
			}, {
				name: '单元',
				avatar: '/static/imgs/a4.jpg',
				desc: '66.8万粉丝',
				content: '快速实现各种cell，四段式设计，满足大都数需求。特别复杂的cell应该考虑重新设计，而不是去修改适配。',
				cover: '/static/imgs/c4.jpg',
				badge: 9,
				identity: '建筑师',
				page: 'base_cell'
			}, {
				name: '宫格',
				avatar: '/static/imgs/a5.jpg',
				desc: '76.2万粉丝',
				content: '不仅仅只是规矩的宫格，您可以利用grid快速实现各种排版。越用越灵活',
				cover: '/static/imgs/c5.jpg',
				badge: 7,
				identity: '灵魂画手',
				page: 'base_grid'
			}, {
				name: '标签',
				avatar: '/static/imgs/a6.jpg',
				desc: '166.8万粉丝',
				content: '带各种状态的标签，还提供单多选模式的示范',
				cover: '/static/imgs/c6.jpg',
				badge: 2,
				identity: '厨师',
				page: 'base_tag'
			}, {
				name: '标题',
				avatar: '/static/imgs/a7.jpg',
				desc: '16.2万粉丝',
				content: '各种快速标题。基本满足大都数样式',
				cover: '/static/imgs/c7.jpg',
				badge: 3,
				identity: '歌手',
				page: 'base_title'
			}, {
				name: 'tabs',
				avatar: '/static/imgs/a8.jpg',
				desc: '76.3万粉丝',
				content: 'tabs，可切换当前，可自动居中。支持多种排版样式',
				cover: '/static/imgs/c8.jpg',
				badge: 9,
				identity: '演员',
				page: 'base_tabs'
			}, {
				name: '开关',
				avatar: '/static/imgs/a9.jpg',
				desc: '66.5万粉丝',
				content: '状态的切换，所有的内容都可以直接配置',
				cover: '/static/imgs/c9.jpg',
				badge: 3,
				identity: '说唱大师',
				page: 'base_switch'
			}, {
				name: '步进器',
				avatar: '/static/imgs/a10.jpg',
				desc: '16.2万粉丝',
				content: 'stepper',
				...
				name: '进度条',
				avatar: '/static/imgs/a12.jpg',
				desc: '116.4万粉丝',
				content: 'progress',
				cover: '/static/imgs/c12.jpg',
				badge: 6,
				identity: '厨师',
				page: 'base_progress'
			}, {
